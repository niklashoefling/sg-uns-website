    ...
    <div className="min-h-screen bg-white">
      <div className="bg-secondary pt-32 pb-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-5xl font-bold text-white">Mannschaften</h1>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="flex flex-col gap-5">
          {mannschaften.map((team, i) => (
            ...
            >
              <div className="relative w-full md:w-48 h-44 md:h-auto shrink-0 bg-secondary/10">
                {team.teamfoto ? (
                  <Image
                    src={team.teamfoto}
              ...
              <div className="flex flex-1 flex-col md:flex-row md:items-center gap-4 p-6">
                <div className="shrink-0 w-10 h-10 rounded-full bg-secondary/10 border border-secondary/20 flex items-center justify-center group-hover:bg-primary/10 group-hover:border-primary/30 transition-colors">
                  <span className="text-secondary group-hover:text-primary font-bold transition-colors">{i + 1}</span>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 line-clamp-1">{team.beschreibung}</p>
                </div>
